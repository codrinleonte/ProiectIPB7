...
public class AccessAdminBDTest {
	...
	public void testSelectMesaje() {
		...
		AccessBD access = bd.getAccess();
		  ...
		  AccessAdminBD  test = ((AccessAdminBD) access);
	...
	public void testSelectConturi() {
		...
		AccessBD access = bd.getAccess();
	        ...
	        List<IntrareConturi> result = test.selectConturi();
			...
			cont.setToken("Token Ciudat");
			expect.add(cont);
			
			cont = new IntrareConturi();
			cont.setId(2);
			cont.setUsername("jimmy.jimmy");
			cont.setHashparola("jimmy");
			cont.setEmail("jimmy.jimmy@ifo.uaic.ro");
			cont.setTipUtilizator("Student");
			cont.setStatus(1);
			cont.setCodActivare("fsdagfsdg");
			cont.setToken("0");
			expect.add(cont);
			
			cont = new IntrareConturi();
			cont.setId(3);
			cont.setUsername("grigory.grigory");
			cont.setHashparola("grigory");
			cont.setEmail("grigory.grygory@info.uaic.ro");
			cont.setTipUtilizator("Student");
			cont.setStatus(0);
			cont.setCodActivare("safasfasf");
			cont.setToken("0");
			expect.add(cont);
			
			cont = new IntrareConturi();
			cont.setId(4);
			cont.setUsername("robert.otrocol");
			cont.setHashparola("hashparola");
			cont.setEmail("robert.otrocol@info.uaic.ro");
			cont.setTipUtilizator("Student");
			cont.setStatus(0);
			cont.setCodActivare("10871848310515576845");
			cont.setToken("0");
			expect.add(cont);
	...
	public void testSelectComisii() {
        ...
        List<IntrareComisii> result = test.selectComisii();
		
		List<IntrareComisii> expect = new ArrayList<IntrareComisii>();
		IntrareComisii com = new IntrareComisii();
		...
		com.setIdProf4(4);
		com.setIdSecretar(1);
		com.setTipComisie("licenta");
		com.setIdEvaluare(1);
		expect.add(com);
		
		com = new IntrareComisii();
		com.setId(2);
		com.setIdProfSef(1);
		com.setIdProf2(2);
		com.setIdProf3(3);
	...
	public void testUpdateMesaj() {
		...
		int result = test.updateMesaj(mesaj);
		int expect = 0;
	...
	public void testUpdateCont() {
		...
		cont.setId(2);
		cont.setUsername("jimmy.jimmy");
		cont.setHashparola("newjimmy");
		cont.setEmail("jimmy.jimmy@info.uaic.ro");
		cont.setTipUtilizator("Student");
		cont.setCodActivare("fsdagfsdg");
		cont.setStatus(1);
		cont.setToken("00");
		int result = test.updateCont(cont);
		int expect = 0;
	...
	public void testUpdateProfesor() {
		...
		prof.setGradDidactic("Conf. DR.");
		prof.setIdComisie(1);
		prof.setFunctieComisie("Examinaator");
		int result = test.updateProfesor(prof);
		int expect = 0;
		...
		prof.setIdComisie(1);
		prof.setFunctieComisie("Examinaator");
		result = test.updateProfesor(prof);
		expect = -1;
	...
	public void testUpdateComisie() {
		...
		com.setIdProf3(3);
		com.setIdProf4(4);
		com.setIdSecretar(15);
		com.setTipComisie("licenta");
		com.setIdEvaluare(1);
		int result = test.updateComisie(com);
		int expect = 0;
	...
	@Test
	public void testUpdateEvaluare() { 
		...
		eval.setSfarsitEvaluare(java.sql.Timestamp.valueOf("2018-01-03 00:00:00"));
		eval.setSala("C308");
		int result = test.updateEvaluare(eval);
		int expect = 0;
		...
		eval.setSfarsitEvaluare(java.sql.Timestamp.valueOf("2018-01-03 00:00:00"));
		eval.setSala("C308");
		result = test.updateEvaluare(eval);
		expect = -1;
	...
	public void testUpdateDetaliiLicenta() {
		...
		dlic.setNota5Proiect(8);
		dlic.setDataOraSustinerii(java.sql.Timestamp.valueOf("2017-09-10 13:30:00"));
		result = test.updateDetaliiLicenta(dlic);
		expect = -1;
	...
	public void testUpdateSesiune() {
		...
		IntrareSesiuni sesiune = new IntrareSesiuni();
		sesiune.setId(1);
		sesiune.setInceputSesiune(java.sql.Timestamp.valueOf("2018-01-01 08:30:00"));
		sesiune.setSfarsitSesiune(java.sql.Timestamp.valueOf("2018-02-01 13:30:00"));
		int result = test.updateSesiune(sesiune);
		int expect = 0;
		...
		sesiune.setInceputSesiune(java.sql.Timestamp.valueOf("2018-01-01 08:30:00"));
		sesiune.setSfarsitSesiune(java.sql.Timestamp.valueOf("2018-02-01 13:30:00"));
		result = test.updateSesiune(sesiune);
		expect = -1;
	...
	public void testInsertCont() {
		...
		cont.setTipUtilizator("Student");
		cont.setStatus(0);
		cont.setCodActivare("54654654654");
		cont.setToken("123");
		int result = test.insertCont(cont);
		int expect = 0;
		
		assertEquals(expect, result);
		
		cont = new IntrareConturi();
		cont.setUsername("vlad.popescu");
		cont.setHashparola("parola");
		cont.setEmail("vlad.popescu@info.uaic.ro");
		cont.setTipUtilizator("Student");
		cont.setStatus(0);
		cont.setCodActivare("54654654654");
		cont.setToken("123");
		result = test.insertCont(cont);
		expect = 0;
	...
	public void testInsertStudent() {
		...
		IntrareStudenti stud = new IntrareStudenti();
		stud.setId(3);
		stud.setNrMatricol("6894SL28648");
		stud.setNume("aungurenci");
		stud.setPrenume("andreea");
		stud.setId_comisie(1);
		stud.setIdSesiune(1);
		int result = test.insertStudent(stud);
		int expect = 0;
		
		assertEquals(expect, result);
		
		stud = new IntrareStudenti();
		stud.setNrMatricol("2894SL28625");
		stud.setNume("popescu");
		stud.setPrenume("vlad");
		stud.setId_comisie(1);
		stud.setIdSesiune(1);
		result = test.insertStudent(stud);
		expect = 0;
	...
	public void testInsertProfesor() {
		...
		prof.setGradDidactic("Conf. DR.");
		prof.setIdComisie(1);
		prof.setFunctieComisie("Examinator");
		int result = test.insertProfesor(prof);
		int expect = 0;
		...
		prof.setIdCont(30);
		prof.setNume("Pop");
		prof.setPrenume("Vasile");
		prof.setGradDidactic("Conf. DR.");
		prof.setIdComisie(1);
		prof.setFunctieComisie("Examinator");
		result = test.insertProfesor(prof);
		expect = 0;
	...
	public void testInsertComisie() {
		...
		com.setTipComisie("licenta");
		com.setIdEvaluare(1);
		int result = test.insertComisie(com);
		int expect = 0;
	...
	@Test
	public void testInsertEvaluare() {
		...
		eval.setIdSesiune(1);
		eval.setIdComisie(2);
		eval.setInceputEvaluare(java.sql.Timestamp.valueOf("2018-01-01 12:30:00"));
		eval.setSfarsitEvaluare(java.sql.Timestamp.valueOf("2018-01-03 12:00:00"));
		eval.setSala("C308");
		int result = test.insertEvaluare(eval);
		int expect = 0;
		...
		eval.setSfarsitEvaluare(java.sql.Timestamp.valueOf("2018-01-03 12:00:00"));
		eval.setSala("C308");
		result = test.insertEvaluare(eval);
		expect = 0;
	...
	public void testInsertLicenta() {
		...
		licenta.setIdSesiune(1);
		licenta.setTipLucrare("Licenta");
		int result = test.insertLicenta(licenta);
		int expect = 0;
		...
		licenta.setIdSesiune(1);
		licenta.setTipLucrare("Licenta");
		result = test.insertLicenta(licenta);
		expect = 0;
	...
	public void testInsertSesiune() {
		...
		IntrareSesiuni sesiune = new IntrareSesiuni();
		sesiune.setId(3);
		sesiune.setInceputSesiune(java.sql.Timestamp.valueOf("2017-07-01 08:30:00"));
		sesiune.setSfarsitSesiune(java.sql.Timestamp.valueOf("2017-07-14 13:30:00"));
		int result = test.insertSesiune(sesiune);
		int expect = 0;
		
		assertEquals(expect, result);
		
		sesiune = new IntrareSesiuni();
		sesiune.setInceputSesiune(java.sql.Timestamp.valueOf("2018-07-01 08:30:00"));
		sesiune.setSfarsitSesiune(java.sql.Timestamp.valueOf("2018-07-14 13:30:00"));
		result = test.insertSesiune(sesiune);
		expect = 0;
	...
	public void testDropMesaj() {
		...
		mesaj.setIdEmitator(2);
		mesaj.setMesaj("Schimba ora evaluarii");
		int result = test.dropMesaj(mesaj);
		int expect = 0;
	...
	public void testDropStudent() {
		...
		stud.setId_comisie(1);
		stud.setIdSesiune(1);
		int result = test.dropStudent(stud);
		int expect = 0;
	...
	public void testDropProfesor() {
		...
		prof.setIdComisie(1);
		prof.setFunctieComisie("Examinator");
		int result = test.dropProfesor(prof);
		int expect = 0;
	...
	public void testDropComisie() {
		...
		com.setTipComisie("licenta");
		com.setIdEvaluare(1);
		int result = test.dropComisie(com);
		int expect = 0;
	...
	public void testDropEvaluare() {
		...
		eval.setSfarsitEvaluare(java.sql.Timestamp.valueOf("2018-01-03 12:00:00"));
		eval.setSala("C308");
		int result = test.dropEvaluare(eval);
		int expect = 0;
	...
	public void testDropDetaliiLicenta() {
		...
		dlic.setNota5Proiect(8);
		dlic.setDataOraSustinerii(java.sql.Timestamp.valueOf("2017-09-10 13:30:00"));
		int result = test.dropDetaliiLicenta(dlic);
		int expect = 0;
		...
		dlic.setNota5Proiect(8);
		dlic.setDataOraSustinerii(java.sql.Timestamp.valueOf("2017-09-10 13:30:00"));
		result = test.dropDetaliiLicenta(dlic);
		expect = -1;
	...
	public void testDropLicenta() {
		...
		licenta.setIdSesiune(1);
		licenta.setTipLucrare("Licenta");
		int result = test.dropLicenta(licenta);
		int expect = 0;
		...
		licenta.setIdSesiune(1);
		licenta.setTipLucrare("Licenta");
		result = test.dropLicenta(licenta);
		expect = -1;
	...
	public void testDropSesiune() {
		...
		sesiune.setInceputSesiune(java.sql.Timestamp.valueOf("2017-07-01 08:30:00"));
		sesiune.setSfarsitSesiune(java.sql.Timestamp.valueOf("2017-07-14 13:30:00"));
		int result = test.dropSesiune(sesiune);
		int expect = -1;
		...
		sesiune.setInceputSesiune(java.sql.Timestamp.valueOf("2017-07-01 08:30:00"));
		sesiune.setSfarsitSesiune(java.sql.Timestamp.valueOf("2017-07-14 13:30:00"));
		result = test.dropSesiune(sesiune);
		expect = 0;
