...
public class AccessProfesorBDTest {

	@Test
	public void testSelectMesaje() {
		
		BD bd = new BD();
		AccessBD access = bd.login("lenuta.alboaie", "parola");
		
		if( access.getTip().equals("Access_Teacher") )
		{
			AccessProfesorBD accessProf = (AccessProfesorBD) access;
			List<IntrareMesaje> result = accessProf.selectMesaje();
	...
	public void testSelectDetaliiLicente() {
		...
		{
			AccessProfesorBD accessProf = (AccessProfesorBD) access;
			List<IntrareDetaliiLicente> result = accessProf.selectDetaliiLicente();
	...
	public void testSelectLicente() {
		...
		{
			AccessProfesorBD accessProf = (AccessProfesorBD) access;
			List<IntrareLicente> result = accessProf.selectLicente();
	...
	public void testSelectSesiuni() {
		...
		{
			AccessProfesorBD accessProf = (AccessProfesorBD) access;
			List<IntrareSesiuni> result = accessProf.selectSesiuni();
	...
	public void testSelectStudenti() {
		...
		{
			AccessProfesorBD accessProf = (AccessProfesorBD) access;
			List<IntrareStudenti> result = accessProf.selectStudenti();
	...
	public void testSelectProfesori() {
		...
		{
			AccessProfesorBD accessProf = (AccessProfesorBD) access;
			List<IntrareProfesori> result = accessProf.selectProfesori();
	...
	public void testUpdateStudent() {
		...
		if( access.getTip().equals("Access_Teacher") )
		{
			...
			student.setId_comisie(1);
			student.setIdSesiune(3);
			int result = accessProf.updateStudent(student);
			int expect = 0;
			...
			student.setId_comisie(1);
			student.setIdSesiune(3);
			result = accessProf.updateStudent(student);
		    expect = -1;
	...
	public void testUpdateLicenta() {
		...
		if( access.getTip().equals("Access_Teacher") )
		{
			...
			licenta.setIdSesiune(1);
			licenta.setTipLucrare("LICENTA");
			int result = accessProf.updateLicenta(licenta);
			int expect = 0;
			...
			licenta.setIdSesiune(1);
			licenta.setTipLucrare("LICENTA");
			result = accessProf.updateLicenta(licenta);
			expect = -1;
	...
	public void testUpdateDetaliiLicenta() {
		...
		if( access.getTip().equals("Access_Teacher") )
		{
			...
			int result = accessProf.updateDetaliiLicenta(licenta);
			int expect = 0;
			...
			result = accessProf.updateDetaliiLicenta(licenta);
			expect = -1;
