...
import bd.AccessAdminBD;
import bd.AccessBD;
import bd.AccessStudentBD;
import bd.BD;
...
public class AccessStudentBDTest {
	...
	public void testSelectDetaliiLicente() {
		...
		BD bd = new BD();
		AccessBD access = bd.login("ionescu.mircea", "parola");
		
		if( access.getTip().equals("Access_Student") )
		{
			AccessStudentBD accessStudent = (AccessStudentBD) access;
			List<IntrareDetaliiLicente> result = accessStudent.selectDetaliiLicente();
	...
	public void testSelectLicente() {
		...
		{
			AccessStudentBD accessStudent = (AccessStudentBD) access;
			List<IntrareLicente> result = accessStudent.selectLicente();
	...
	public void testSelectSesiuni() {
		...
		{
			AccessStudentBD accessStudent = (AccessStudentBD) access;
			List<IntrareSesiuni> result = accessStudent.selectSesiuni();
	...
	public void testSelectMesaje() {
		...
		{
			AccessStudentBD accessStudent = (AccessStudentBD) access;
			List<IntrareMesaje> result = accessStudent.selectMesaje();
	...
	public void testSelectStudenti() {
		...
		{
			AccessStudentBD accessStudent = (AccessStudentBD) access;
			List<IntrareStudenti> result = accessStudent.selectStudenti();
	...
	public void testSelectProfesori() {
		...
		{
			AccessStudentBD accessStudent = (AccessStudentBD) access;
			List<IntrareProfesori> result = accessStudent.selectProfesori();
	...
	public void testUpdateStudent() {
		...
		if( access.getTip().equals("Access_Student") )
		{
			...
			student.setId_comisie(1);
			student.setIdSesiune(3);
			int result = accessStudent.updateStudent(student);
			int expect = 0;
			...
			student.setId_comisie(1);
			student.setIdSesiune(3);
			result = accessStudent.updateStudent(student);
		    expect = -1;
	...
	public void testUpdateLicenta() {
		...
		if( access.getTip().equals("Access_Student") )
		{
			...
			licenta.setIdSesiune(1);
			licenta.setTipLucrare("LICENTA");
			int result = accessStudent.updateLicenta(licenta);
			int expect = 0;
			...
			licenta.setIdSesiune(1);
			licenta.setTipLucrare("LICENTA");
			result = accessStudent.updateLicenta(licenta);
			expect = -1;
	...
	public void testInsertDetaliiLicenta() {
		...
		if( access.getTip().equals("Access_Student") )
		{
			...
			int result = accessStudent.insertDetaliiLicenta(licenta);
			int expect = -1;
			...
			result = accessStudent.insertDetaliiLicenta(licenta);
			expect = 0;
	...
	public void testInsertLicenta() {
		...
		if( access.getTip().equals("Access_Student") )
		{
			...
			licenta.setIdSesiune(1);
			licenta.setTipLucrare("LICENTA");
			int result = accessStudent.insertLicenta(licenta);
			int expect = 0;
			...
			licenta.setIdSesiune(1);
			licenta.setTipLucrare("LICENTA");
			result = accessStudent.insertLicenta(licenta);
			expect = -1;
