...
import bd.AccessBD;
import bd.AccessSecretarBD;
import bd.BD;
import bd.IntrareComisii;
import bd.IntrareDetaliiLicente;
import bd.IntrareEvaluari;
import bd.IntrareLicente;
import bd.IntrareMesaje;
import bd.IntrareProfesori;
import bd.IntrareSesiuni;
import bd.IntrareStudenti;
...
public class AccessSecretarBDTest {
	...
	public void testSelectMesaje() {
		...
		BD bd = new BD();
		bd.login("lenuta.alboaie", "adria");
		AccessBD access = bd.getAccess();
		AccessSecretarBD  test = ((AccessSecretarBD) access);
