...
public class IntrareStudenti {
    ...
    private IntrareDetaliiLicente detaliiLicenta = new IntrareDetaliiLicente();

    public IntrareDetaliiLicente getDetaliiLicenta() {
        return detaliiLicenta;
    }

    public void setDetaliiLicenta(IntrareDetaliiLicente detaliiLicenta) {
        this.detaliiLicenta = detaliiLicenta;
    }
